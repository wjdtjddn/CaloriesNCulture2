...
public class culture34_CustomAdapter extends BaseAdapter {

    private ArrayList<CultureDTO> listCustom = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CultureDTO dto = listCustom.get(position);
    ...
    public void addItem(CultureDTO dto) {
        listCustom.add(dto);
    }
    /*public void remove(String click_title) {
        listCustom.remove(click_title);
    }*/
}