...
public class MainAcivity_cal_aditm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(MainAcivity_cal_aditm.this, foodname_m_edit, Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if (result.equals("ok")) {
                ...
                Toast.makeText(MainAcivity_cal_aditm.this, result, Toast.LENGTH_SHORT).show();
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                URL url = new URL("http://106.241.33.158:1080/EditFoodM.jsp");//바꿔주세요
